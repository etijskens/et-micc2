!-------------------------------------------------------------------------------------------------
! Fortran source code for module {{tmpl.package_name}}.{{tmpl.module_name}}
!-------------------------------------------------------------------------------------------------
! Remarks:
!   . Enter Python documentation for this module in ``./{{tmpl.module_name}}.rst``.
...
subroutine add(x,y,z,n)
  ...
  !
  ! Python use:
  !    import {{tmpl.project_name}}.{{tmpl.module_name}} as f90
